...
# 2 "<built-in>" 2
# 1 "fir128_Q1/fir.cpp" 2
# 13 "fir128_Q1/fir.cpp"
# 1 "fir128_Q1/fir.h" 1
# 10 "fir128_Q1/fir.h"
const int N=128;
...
# 16 "fir128_Q1/fir.cpp" 2
typedef ap_int<64> reg_t;
__attribute__((sdx_kernel("fir", 0))) void fir (data_t *y,data_t x){
#line 17 "D:/HLS/HLS_LabB/fir128_Q1/64bit/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=fir
# 17 "fir128_Q1/fir.cpp"

#line 6 "D:/HLS/HLS_LabB/fir128_Q1/64bit/directives.tcl"
#pragma HLSDIRECTIVE TOP name=fir
# 17 "fir128_Q1/fir.cpp"
