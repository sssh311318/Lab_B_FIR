...
set portList { 
	...
	{ conv2_i_i sc_in sc_lv 16 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "conv2_i_i", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "conv2_i_i", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_5s_16s_21_1_1_U1", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	conv2_i_i { ap_none {  { conv2_i_i in_data 0 16 } } }
