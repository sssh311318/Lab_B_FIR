...
architecture behav of fir is 
    ...
    "fir_fir,hls_ip_2022_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.508000,HLS_SYN_LAT=261,HLS_SYN_TPT=none,HLS_SYN_MEM=2,HLS_SYN_DSP=0,HLS_SYN_FF=175,HLS_SYN_LUT=296,HLS_VERSION=2022_1}";
    ...
    signal empty_7_fu_83_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal empty_7_reg_103 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal empty_6_fu_70_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    empty_6_fu_70_p2 <= std_logic_vector(shift_left(unsigned(x),to_integer(unsigned('0' & ap_const_lv32_1(31-1 downto 0)))));
    empty_7_fu_83_p1 <= x(8 - 1 downto 0);
    ...
    mul_fu_76_p2 <= std_logic_vector(unsigned(empty_fu_64_p2) + unsigned(empty_6_fu_70_p2));
