...
# 2 "<built-in>" 2
# 1 "fir128_Q2/fir.cpp" 2
# 13 "fir128_Q2/fir.cpp"
# 1 "fir128_Q2/fir.h" 1
# 10 "fir128_Q2/fir.h"
const int N=128;
...
# 16 "fir128_Q2/fir.cpp" 2
typedef ap_int<8> reg_t;
__attribute__((sdx_kernel("fir", 0))) void fir (data_t *y,data_t x){
#line 17 "D:/HLS/HLS_LABC/fir128_Q2/solution2/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=fir
# 17 "fir128_Q2/fir.cpp"

#line 6 "D:/HLS/HLS_LABC/fir128_Q2/solution2/directives.tcl"
#pragma HLSDIRECTIVE TOP name=fir
# 17 "fir128_Q2/fir.cpp"
 ...
 Shift_Accum_Loop:
 for (i = 128 - 1; i >= 0; i--) {
#line 7 "D:/HLS/HLS_LABC/fir128_Q2/solution2/directives.tcl"
#pragma HLSDIRECTIVE PIPELINE II=2
# 28 "fir128_Q2/fir.cpp"
