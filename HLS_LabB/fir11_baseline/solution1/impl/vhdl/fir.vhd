...
architecture behav of fir is 
    ...
    signal mul_reg_84 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal grp_fu_62_p1 : STD_LOGIC_VECTOR (6 downto 0);
...
begin
    ...
    mul_32s_7ns_32_2_1_U8 : component fir_mul_32s_7ns_32_2_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, grp_fir_Pipeline_Shift_Accum_Loop_fu_51_ap_done, ap_CS_fsm_state4)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state4 => 
                if (((grp_fir_Pipeline_Shift_Accum_Loop_fu_51_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
    ...
    ap_ST_fsm_state4_blk_assign_proc : process(grp_fir_Pipeline_Shift_Accum_Loop_fu_51_ap_done)
    begin
    ...
    grp_fu_62_p1 <= ap_const_lv32_35(7 - 1 downto 0);
