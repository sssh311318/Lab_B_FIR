...
# 2 "<built-in>" 2
# 1 "fir11_baseline/fir.cpp" 2
# 13 "fir11_baseline/fir.cpp"
# 1 "fir11_baseline/fir.h" 1
# 10 "fir11_baseline/fir.h"
const int N=11;
...
# 16 "fir11_baseline/fir.cpp" 2
typedef int coef_t;
typedef int data_t;
typedef int acc_t;

__attribute__((sdx_kernel("fir", 0))) void fir (data_t *y,data_t x){
#line 17 "D:/HLS/HLS_LABC/fir11_baseline/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=fir
# 20 "fir11_baseline/fir.cpp"

 coef_t c[11] = {53, 0, -91, 0, 313, 500, 313, 0, -91, 0,53};
