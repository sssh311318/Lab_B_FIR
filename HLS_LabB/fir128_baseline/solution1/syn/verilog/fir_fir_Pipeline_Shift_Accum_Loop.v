...
reg   [0:0] icmp_ln28_reg_234;
reg   [0:0] icmp_ln28_reg_234_pp0_iter1_reg;
reg   [0:0] icmp_ln28_reg_234_pp0_iter2_reg;
reg   [0:0] icmp_ln28_reg_234_pp0_iter3_reg;
reg  signed [31:0] shift_reg_load_reg_248;
reg  signed [31:0] fir_int_int_c_load_reg_253;
wire   [31:0] grp_fu_183_p2;
reg   [31:0] mul_ln33_reg_258;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_143)) begin
        if (((tmp_fu_138_p3 == 1'd0) & (icmp_ln28_fu_155_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_reg_225 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln28_reg_234 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_reg_225_pp0_iter2_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln28_reg_234_pp0_iter2_reg == 1'd0))) begin
        mul_ln33_reg_258 <= grp_fu_183_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_reg_225 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln28_reg_234 == 1'd0))) begin
...
always @ (*) begin
    if (((tmp_reg_225_pp0_iter3_reg == 1'd0) & (icmp_ln28_reg_234_pp0_iter3_reg == 1'd0))) begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_279)) begin
        ...
        end else if ((icmp_ln28_fu_155_p2 == 1'd0)) begin
            shift_reg_address1 = zext_ln32_fu_167_p1;
        end else begin
...
always @ (*) begin
    if ((((tmp_fu_138_p3 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln28_fu_155_p2 == 1'd1)) | ((tmp_fu_138_p3 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln28_fu_155_p2 == 1'd0)))) begin
        shift_reg_ce1 = 1'b1;
    end else begin
        shift_reg_ce1 = 1'b0;
    end
...
always @ (*) begin
    if (((tmp_fu_138_p3 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln28_fu_155_p2 == 1'd1))) begin
        shift_reg_we1 = 1'b1;
    end else begin
        shift_reg_we1 = 1'b0;
    end
...
assign add_ln27_fu_172_p2 = ($signed(ap_sig_allocacmp_i_1) + $signed(8'd255));

assign add_ln32_fu_161_p2 = ($signed(empty_6_fu_151_p1) + $signed(7'd127));
...
assign icmp_ln28_fu_155_p2 = ((ap_sig_allocacmp_i_1 == 8'd0) ? 1'b1 : 1'b0);

assign shift_reg_address0 = i_cast1_reg_229;

assign tmp_fu_138_p3 = ap_sig_allocacmp_i_1[32'd7];

assign zext_ln32_fu_167_p1 = add_ln32_fu_161_p2;
